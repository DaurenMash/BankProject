...
public class KafkaUpdateUserTest {
    ...
    private static final Long SET_ID = 24L;
    private static final Long SET_PROFILE_ID = 555L;
    ...
    private static void loadConfig() {
        ...
        try (InputStream input = KafkaUpdateUserTest.class.getClassLoader().getResourceAsStream("config.properties")) {
            if (input != null) {
